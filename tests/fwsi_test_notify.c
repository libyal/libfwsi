...
/* Tests the libfwsi_notify_set_verbose function
 * Returns 1 if successful or 0 if not
 */
int fwsi_test_notify_set_verbose(
     void )
{
...
/* Tests the libfwsi_notify_set_stream function
 * Returns 1 if successful or 0 if not
 */
int fwsi_test_notify_set_stream(
     void )
{
	...
	/* Test regular cases
	 */
	result = libfwsi_notify_set_stream(
	          NULL,
	          &error );
...
/* Tests the libfwsi_notify_stream_open function
 * Returns 1 if successful or 0 if not
 */
int fwsi_test_notify_stream_open(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
	...
	/* Test regular cases
	 */
	result = libfwsi_notify_stream_open(
	          "notify_stream.log",
	          &error );
	...
	/* Clean up
	 */
	result = libfwsi_notify_stream_close(
	          &error );
...
/* Tests the libfwsi_notify_stream_close function
 * Returns 1 if successful or 0 if not
 */
int fwsi_test_notify_stream_close(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	FWSI_TEST_RUN(
	 "libfwsi_notify_set_verbose",
	 fwsi_test_notify_set_verbose )

	FWSI_TEST_RUN(
	 "libfwsi_notify_set_stream",
	 fwsi_test_notify_set_stream )

	FWSI_TEST_RUN(
	 "libfwsi_notify_stream_open",
	 fwsi_test_notify_stream_open )

	FWSI_TEST_RUN(
	 "libfwsi_notify_stream_close",
	 fwsi_test_notify_stream_close )

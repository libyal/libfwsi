...
PyTypeObject pyfwsi_extension_blocks_type_object = {
	...
	/* tp_doc */
	"pyfwsi sequence and iterator object of extension blocks",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
...
/* Creates a new extension blocks sequence and iterator object
...
PyObject *pyfwsi_extension_blocks_new(
           ...
           int number_of_items )
{
	pyfwsi_extension_blocks_t *sequence_object = NULL;
           ...
           Py_ssize_t item_index )
{
	...
	extension_block_object = sequence_object->get_item_by_index(

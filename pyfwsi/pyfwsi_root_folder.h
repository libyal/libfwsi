...
#if !defined( _PYFWSI_ROOT_FOLDER_H )
#define _PYFWSI_ROOT_FOLDER_H
...
extern PyMethodDef pyfwsi_root_folder_object_methods[];
extern PyTypeObject pyfwsi_root_folder_type_object;

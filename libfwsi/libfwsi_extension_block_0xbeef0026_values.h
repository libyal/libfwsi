...
#if !defined( _LIBFWSI_EXTENSION_BLOCK_0xBEEF0026_VALUES_H )
#define _LIBFWSI_EXTENSION_BLOCK_0xBEEF0026_VALUES_H
...
typedef struct libfwsi_extension_block_0xbeef0026_values libfwsi_extension_block_0xbeef0026_values_t;

struct libfwsi_extension_block_0xbeef0026_values
{
	/* Dummy
	 */
	int dummy;
...
#endif /* !defined( _LIBFWSI_EXTENSION_BLOCK_0xBEEF0026_VALUES_H ) */

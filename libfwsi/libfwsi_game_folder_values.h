...
#if !defined( _LIBFWSI_GAME_FOLDER_VALUES_H )
#define _LIBFWSI_GAME_FOLDER_VALUES_H
...
typedef struct libfwsi_game_folder_values libfwsi_game_folder_values_t;

struct libfwsi_game_folder_values
{
	/* Dummy
	 */
	int dummy;

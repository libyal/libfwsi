		...
		if( libcnotify_verbose != 0 )
		{
			...
			if( result != 1 )
			{
				libcerror_error_set(
				 ...
				 LIBCERROR_ERROR_DOMAIN_RUNTIME,
				 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
				 "%s: unable to determine size of file system string.",
				 function );
			...
			if( value_string_size > (size_t) ( SSIZE_MAX / sizeof( libcstring_system_character_t ) ) )
			{
				libcerror_error_set(
				 ...
				 LIBCERROR_ERROR_DOMAIN_RUNTIME,
				 LIBCERROR_RUNTIME_ERROR_VALUE_EXCEEDS_MAXIMUM,
				 "%s: invalid file system string size value exceeds maximum.",
				 function );
			...
			if( value_string == NULL )
			{
				libcerror_error_set(
				 ...
				 LIBCERROR_ERROR_DOMAIN_MEMORY,
				 LIBCERROR_MEMORY_ERROR_INSUFFICIENT,
				 "%s: unable to create file system string.",
				 function );
			...
			if( result != 1 )
			{
				libcerror_error_set(
				 ...
				 LIBCERROR_ERROR_DOMAIN_RUNTIME,
				 LIBCERROR_RUNTIME_ERROR_SET_FAILED,
				 "%s: unable to set file system string.",
				 function );

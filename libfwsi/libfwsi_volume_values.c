     ...
     libcerror_error_t **error )
{
	...
	if( class_type_indicator == 0x2e )
	{
		...
		volume_values->has_identifier = 1;
...
int libfwsi_volume_values_get_identifier(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfwsi_volume_values_get_identifier";
	...
	if( volume_values->has_identifier == 0 )
	{
		return( 0 );
	}
	if( memory_copy(
...
int libfwsi_volume_values_get_shell_folder_identifier(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfwsi_volume_values_get_shell_folder_identifier";
	...
	if( volume_values->has_shell_folder_identifier == 0 )
	{
		return( 0 );
	}
	if( memory_copy(

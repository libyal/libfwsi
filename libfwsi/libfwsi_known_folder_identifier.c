...
libfwsi_known_folder_identifier_definition_t libfwsi_known_folder_identifier_definitions[ ] = {
	...
	{ libfwsi_known_folder_identifier_sendto,
	  "SendTo" },
	{ libfwsi_known_folder_identifier_skydrive,
	  "SkyDrive" },
	{ libfwsi_known_folder_identifier_skydrivecameraroll,
	  "SkyDriveCameraRoll" },
	{ libfwsi_known_folder_identifier_skydrivedocuments,
	  "SkyDriveDocuments" },
	{ libfwsi_known_folder_identifier_skydrivepictures,
	  "SkyDrivePictures" },

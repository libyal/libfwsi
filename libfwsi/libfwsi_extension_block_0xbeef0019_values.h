...
#if !defined( _LIBFWSI_EXTENSION_BLOCK_0xBEEF0019_VALUES_H )
#define _LIBFWSI_EXTENSION_BLOCK_0xBEEF0019_VALUES_H
...
typedef struct libfwsi_extension_block_0xbeef0019_values libfwsi_extension_block_0xbeef0019_values_t;

struct libfwsi_extension_block_0xbeef0019_values
{
	/* Dummy
	 */
	int dummy;

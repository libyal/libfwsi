...
#if !defined( _LIBFWSI_CDBURN_VALUES_H )
#define _LIBFWSI_CDBURN_VALUES_H
...
typedef struct libfwsi_cdburn_values libfwsi_cdburn_values_t;

struct libfwsi_cdburn_values
{
	/* Dummy
	 */
	int dummy;

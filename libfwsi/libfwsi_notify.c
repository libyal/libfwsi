...
{
	static char *function = "libfwsi_notify_set_stream";
...
int libfwsi_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfwsi_notify_stream_open";
...
int libfwsi_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfwsi_notify_stream_close";
